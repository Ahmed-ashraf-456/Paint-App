...
void DrawAssistant::setarea(double areafromcanvas)
{
area = areafromcanvas;
}

void DrawAssistant::setparimeter(double parimeterfromcanvas)
{
parimeter = parimeterfromcanvas;
}

void DrawAssistant::setname(QString namefromcanvas)
{
name = namefromcanvas;
}

double DrawAssistant::getarea()const
{
return area;
}

double DrawAssistant::getparimeter()const
{
return parimeter;
}

QString DrawAssistant::getname() const
{
    return name;
}

DrawAssistant::DrawAssistant(float x, float y, QString w)
{
area =x;
parimeter =y;
name = w;
...
int DrawAssistant::getshapeid()
{
   return xx ;
}

void DrawAssistant::setshapeid(int x)
{
   xx = x;
}
